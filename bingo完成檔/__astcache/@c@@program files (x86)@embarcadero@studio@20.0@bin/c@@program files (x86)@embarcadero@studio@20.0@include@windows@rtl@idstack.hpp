...
// (DO NOT EDIT: machine generated header) 'IdStack.pas' rev: 33.00 (Windows)
...
public:
	...
	virtual NativeUInt __fastcall NewSocketHandle(const int ASocketType, const int AProtocol, const Idglobal::TIdIPVersion AIPVersion = (Idglobal::TIdIPVersion)(0x0), const bool AOverlapped = false) = 0 ;
